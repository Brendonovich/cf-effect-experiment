...
| Function navigation and split constants   | Covered | `function-navigation` | [function-navigation.md](function-navigation.md)           |
| Local function queue definitions/controls | Covered | `function-queues`     | [function-queues.md](function-queues.md)                   |
| Module info, engine, and node reference   | Covered | `module-reference`    | [module-reference.md](module-reference.md)                 |
