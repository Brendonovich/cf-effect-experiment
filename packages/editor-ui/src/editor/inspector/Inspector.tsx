...
export function Inspector(props: {
  ...
  onAddFunctionField: (direction: "input" | "output") => Promise<string | undefined>;
  onUpdateFunctionField: (direction: "input" | "output", field: GraphFunction.Field) => void;
  onReorderFunctionField: (
  ...
  return (
      ...
      fallback={
        <Show
          ...
          fallback={
            <Show
              when={props.module}
              fallback={<div sx={styles.empty}>No information available</div>}
            >
        ...
        >
          {(graph) => (
            <Show
              ...
              fallback={
                <div sx={styles.panel}>
                  <span sx={styles.title}>Graph</span>
                  <div sx={styles.field}>
            ...
            >
              {(fn) => (
                <FunctionInfo
                  ...
                  onAddField={props.onAddFunctionField}
                  onUpdateField={props.onUpdateFunctionField}
                  onReorderField={props.onReorderFunctionField}
                  onDeleteField={props.onDeleteFunctionField}
                />
              )}
            </Show>
          )}
    ...
    >
      {(node) => {
        ...
        return (
          <div sx={styles.panel}>
            <span sx={styles.title}>Node</span>
            <Show when={!schema()}>
