...
const styles = stylex.create({
  ...
  unselectedName: {
    color: colors.gray10,
    "@media (hover: hover)": {
      [stylex.when.ancestor(":hover", tabMarker)]: { color: colors.gray12 },
    },
  },
  ...
  closeArea: {
    ...
    bottom: 0,
    display: "flex",
    opacity: { default: 0, ":focus-within": 1, "@media (pointer: coarse)": 1 },
    position: "absolute",
    right: 0,
    top: 0,
    zIndex: 10,
    "@media (hover: hover)": { [stylex.when.ancestor(":hover", tabMarker)]: { opacity: 1 } },
  },
