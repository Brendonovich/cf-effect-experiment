...
export interface PostgresLogicalDatabaseAttributes {
  ...
  appRolePrivilegesHash?: string | undefined;
...
const isUsablePostgresOrigin = (origin: PostgresOrigin | undefined): origin is PostgresOrigin =>
  origin !== undefined && origin.host !== "" && origin.user !== "";
...
const readLogicalDatabaseSqlFiles = (input: {
  readonly importFiles?: ReadonlyArray<string> | undefined;
