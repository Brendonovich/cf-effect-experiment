...
graph events, matching the legacy action-only module. Disconnected, missing,
...
`SpeakerBot`-prefixed runtime/client RPCs. Settings bind to this module, not the
generic WebSocket module. Empty initial storage opens no sockets. No cloud
...
Runtime dependencies: `@macrograph/module`, `@macrograph/module-websocket-client`,
