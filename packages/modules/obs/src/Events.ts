...
export class SourceFilterListReindexed extends S.TaggedClass<SourceFilterListReindexed>()(
  ...
  { sourceName: S.String, filters: S.Unknown, address: SocketAddress },
) {}
...
export const decode = (
  event: { readonly eventType: string; readonly eventData: unknown },
  address: SocketAddress,
) =>
