import * as WebSocket from "@macrograph/module-websocket-server/Definition";
import { make } from "@macrograph/module-websocket-server/Engine";
import { Adapter } from "@macrograph/module-websocket-server/Listener";
