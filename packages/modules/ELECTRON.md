...
correlation remains in the modules. See those package READMEs for protocol limits
...
The current package-source catalog grows from 23 modules / 426 schemas to
27 modules / 520 schemas: **four new modules and 94 additional nodes**.
...
streaming semantics. See each module README for exact current schemas and limits.
...
| Zigbee2MQTT             |            4 | Intentionally excluded at the user's request; no module or host wiring is included.                                                                                             |
...
capabilities, not additional module menus.
...
Module tests use mocked providers/transports and, for LAN protocols where practical,
...
require `MACROGRAPH_ENABLE_FILE_WRITES=true`. Secrets stay out of module client
