...
Standalone-server module using `socket.io-client` for the Streamlabs Socket API.
...
vault. Module definitions and settings do not import the Socket.IO transport.
...
or tracing below this module boundary may still record the original failure.
