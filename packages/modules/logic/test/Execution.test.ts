...
describe("Logic execution", () => {
  it.effect(
    "evaluates ListLength and IsOptionNone using connected type anchors, and JoinLines defaults",
    () =>
      Effect.gen(function* () {
        const results: Array<{
        ...
        yield* executor.module(StringModule);
    ...
    () =>
      Effect.gen(function* () {
        ...
        const nodes = [
          ...
          invert,
          node("conditional", "logic", "Conditional", {
            condition: true,
            trueValue: "selected",
