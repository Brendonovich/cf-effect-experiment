...
const reward: Input = { id: "rewardId", name: "Reward Id", key: "id" };
const enabled: Input = { id: "enabled", name: "", kind: "bool", location: "body" };
const after: Input = { id: "after", optional: true };
const first = (max: number): Input => ({ id: "first", kind: "int", min: 1, max, optional: true });
const exists = (id: string, name?: string): Output => ({
  id,
  ...(name === undefined ? {} : { name }),
  path: "data.0",
  kind: "exists",
...
export const actions: ReadonlyArray<Action> = [
  ...
  },
  {
    ...
    scopes: ["moderator:manage:banned_users"],
    role: "moderator",
    inputs: [channel, { ...user, name: "userID" }],
    noContent: true,
  },
  ...
  },
  {
    ...
    role: "broadcaster",
    inputs: [channel, user],
    outputs: [exists("moderator", "Moderator")],
  },
  {
    id: "SendWhisper",
    name: "Send Whisper",
  ...
  },
  {
    ...
    outputs: [{ ...json("redemptionJson", "data.0", false), name: "Redemption" }],
  },
  {
    id: "GetRewardByTitle",
  ...
  },
  {
    ...
    outputs: [{ id: "retryAfter", name: "Cooldown", path: "data.0.retry_after", kind: "int" }],
  },
  {
    id: "GetAdSchedule",
  ...
  },
  {
    ...
    scopes: [],
    inputs: [user],
    outputs: [{ id: "color", name: "color", path: "data.0.color", kind: "string", optional: true }],
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { id: "userId", name: "Id Of Shoutout User", key: "to_broadcaster_id" },
    ],
    noContent: true,
  },
  {
    ...
    inputs: [
      channel,
      { id: "message", name: "Announcement", location: "body", min: 1, max: 500 },
      {
        id: "color",
        location: "body",
        optional: true,
  ...
  },
  {
    ...
    inputs: [],
    outputs: [
      { id: "login", name: "Login of Token", path: "login", kind: "string" },
      { id: "userId", name: "User ID of token", path: "user_id", kind: "string" },
      { id: "expiresIn", name: "Token Expires in (s)", path: "expires_in", kind: "int" },
    ],
  },
  {
    id: "GetPolls",
