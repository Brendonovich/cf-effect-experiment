...
import { Function as GraphFunction, GraphId, IoId, Project } from "@macrograph/core";
...
const deployment: Project.Model = {
  ...
  functions: {
    function: {
      canvas: { id: GraphId.make("function"), name: "Function", nodes: {}, connections: [] },
      arguments: [],
      returns: [],
...
describe("Workflow queue awaiting", () => {
  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        const fields: GraphFunction.Field[] = [
          {
            id: IoId.make("dates"),
            name: "Dates",
            type: DataType.List(DataType.Option(DataType.DateTime)),
          },
        ];
        const captured = {
