...
const styles = stylex.create({
  ...
  settingsButton: {
    ...
    color: colors.gray11,
    "@media (hover: hover)": { ":hover": { backgroundColor: colors.gray3, color: colors.gray12 } },
  },
  ...
  close: {
    ...
    transition: "150ms",
    "@media (hover: hover)": { ":hover": { color: colors.gray12, backgroundColor: colors.gray4 } },
  },
  ...
  remove: {
    ...
    backgroundColor: "transparent",
    transition: "150ms",
    "@media (hover: hover)": { ":hover": { color: colors.red11, backgroundColor: colors.red3 } },
  },
});
