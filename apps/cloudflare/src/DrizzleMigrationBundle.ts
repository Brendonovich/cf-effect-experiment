...
type Bundle = Resource<"Macrograph.DrizzleMigrationBundle.Bundle", BundleProps, BundleAttributes>;
...
export const bindBundle = Effect.fnUntraced(function* (
  ...[name, props]: [string, InputProps<BundleProps>]
) {
